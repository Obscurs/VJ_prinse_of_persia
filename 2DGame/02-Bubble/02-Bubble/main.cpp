...
static Game game; // This object represents the whole game
static int prevTime;

// If a key is pressed this callback will be called
static void keyboardDownCallback(unsigned char key, int x, int y)
{
    Game::instance().keyPressed(key);
}

// If a key is released this callback will be called
static void keyboardUpCallback(unsigned char key, int x, int y)
{
    Game::instance().keyReleased(key);
}

// If a special key is pressed this callback will be called
static void specialDownCallback(int key, int x, int y)
{
    Game::instance().specialKeyPressed(key);
}

// If a special key is released this callback will be called
...
static void idleCallback()
{
	...
	{
		// Every time we enter here is the start of a game loop execution
