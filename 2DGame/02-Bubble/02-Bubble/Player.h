...
enum PlayerState {
	...
	TURN_RUNING_RIGHT, TURN_RUNING_LEFT, PRE_JUMPING_RIGHT, PRE_JUMPING_LEFT, PRE_RUNING_RIGHT, PRE_RUNING_LEFT, GRABING_RIGHT, GRABING_LEFT
};
...
enum PlayerAnims
{
	...
	JUMP_STAND_RIGHT, JUMP_STAND_LEFT, FALL_RIGHT, FALL_LEFT, TURN_RUN_RIGHT, TURN_RUN_LEFT, PRE_JUMP_RIGHT, PRE_JUMP_LEFT, PRE_RUN_RIGHT, PRE_RUN_LEFT, GRAB_RIGHT, GRAB_LEFT, 
	GRAB_LEFT_STATIC, GRAB_RIGHT_STATIC,
