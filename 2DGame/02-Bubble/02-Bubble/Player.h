...
enum PlayerAnims
{
	...
	PARRY_RIGHT, PARRY_LEFT, SWORD_STEP_RIGHT, SWORD_STEP_LEFT, DRINK_RIGHT, DRINK_LEFT, PRE_JUMP_RIGHT2, PRE_JUMP_LEFT2, JUMP_RIGHT2, JUMP_LEFT2, 
	POST_JUMP_RIGHT2, POST_JUMP_LEFT2, DAMAGE_LEFT, DAMAGE_RIGHT, DIE_RIGHT, DIE_LEFT, 
